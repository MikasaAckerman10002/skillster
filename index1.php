...
<header class="header">
   ...
   <section class="flex">
      ...
      <nav class="navbar">
         ...
         <a href="feedback/feedback1.php">Feedback</a>
...
<section class="home" id="home">
   ...
   <div class="row">
      ...
      <div class="content">
         <p style = 'font-size:32px; font-style:bold; color:#ffffff;'>welcome <span style='color:#00e77f'><?php echo $_SESSION['user_name'] ?></span></p>
   ...
   <h1 class="heading">What Do You <span>Want To Do?</span></h1>
         ...
         <div class="swiper-slide slide">
            ...
            <p>You are so strained. Your mind must become fresh.
               ...
               <a href="music.html" class="btn1">Listen Now</a>
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <p>Everyday you learn a lot in school. So discover new things
               ...
               <a href="learn.html" class="btn1">Learn Now</a>
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <a href="games.html" class="btn1">Play Now</a>
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <a href="bio.html" class="btn1">Read Now</a>
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <a href="project.html" class="btn1">Let's Go</a>
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <a href="ai.html" class="btn1">Explore Now</a>
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <a href="https://earth.google.com/web/@0,-1.6419,0a,22251752.77375655d,35y,0h,0t,0r" target="_blank" class="btn1">Explore Now</a>
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <a href="https://en.oxforddictionaries.com/" target="_blank" class="btn1">Explore Now</a>
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <a href="https://inshorts.com/en/read/" target="_blank" class="btn1">Read Now</a>
         </div>
